 ...
 */
public class BeanDefaultLifeCycle {
	...
	/**
	 * 全局Bean初始化执行方法：配置文件中根节点beans标签的属性init-method的值来指定Bean初始化执行的方法名称
	 */
	public void defaultInit(){
		System.out.println("Bean初始化执行全局默认指定操作");
	}
	
	/**
	 * 全局Bean销毁执行方法：配置文件中根节点beans标签的属性destroy-method的值来指定Bean销毁执行的方法名称
	 */
	public void defaultDestroy(){
		System.out.println("Bean销毁执行全局默认指定操作");
	}
}
